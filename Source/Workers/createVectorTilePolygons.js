...
define(['./defined-d7f5f932', './Check-bbcbb0e2', './freezeObject-abed2cf1', './defaultValue-23842ffb', './Math-c7c79b58', './Cartesian2-9554c007', './defineProperties-1cf3ebff', './Transforms-149a4caf', './RuntimeError-956ace02', './WebGLConstants-157bb1d6', './when-88f4c09c', './AttributeCompression-2d2071ba', './IndexDatatype-f99b6826', './IntersectionTests-6891685f', './Plane-b02efcec', './createTaskProcessorWorker', './EllipsoidTangentPlane-76f94416', './OrientedBoundingBox-a2f21bd0', './Color-944385e4'], function (defined, Check, freezeObject, defaultValue, _Math, Cartesian2, defineProperties, Transforms, RuntimeError, WebGLConstants, when, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
